										...
										<label for="upload" style="display: inline-block; width:132px;height:192px;">
											<c:choose>
												<c:when test="${empty mediaInfo.haibao}">
													<img id="upload_haibao" src="${pageContext.request.contextPath}/static/javaex/pc/images/default.png" width="100%" height="100%" />
												</c:when>
												<c:otherwise>
										...
										<label for="upload2" style="display: inline-block; width:132px;height:80.6px;">
											<c:choose>
												<c:when test="${empty mediaInfo.dafengmian}">
													<img id="upload_dafengmian" src="${pageContext.request.contextPath}/static/javaex/pc/images/default.png" width="100%" height="100%" />
												</c:when>
												<c:otherwise>
										...
										<label for="upload3" style="display: inline-block; width:132px;height:80.6px;">
											<c:choose>
												<c:when test="${empty mediaInfo.fengmian}">
													<img id="upload_fengmian" src="${pageContext.request.contextPath}/static/javaex/pc/images/default.png" width="100%" height="100%" />
												</c:when>
												<c:otherwise>
