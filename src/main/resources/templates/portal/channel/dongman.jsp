...
<style>
	...
	.kenan{width: 160px;height: 50px;background: url(${pageContext.request.contextPath}/static/images/kn.png) no-repeat 0 0;position: absolute;right: -20px;bottom: 0;}
...
<body>
	...
	<div style="width: 1340px; margin: 20px auto;">
		...
		<div class="block no-shadow">
			<div class="main">
				<c:import url="../ad/ad1.html"></c:import>
			</div>
		</div>
