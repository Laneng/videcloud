...
public class AdminConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/admin/users").setViewName("admin/menu/userList");
        registry.addViewController("/admin/normal").setViewName("admin/menu/normal");
        registry.addViewController("/admin/stop").setViewName("admin/menu/stop");
